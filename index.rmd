...
**Op-Ed.** Students will write op-eds (800 words) that communicate the complexity of a chosen topic at the intersection of ethics, justice, and digital health to a general audience. The primary competency for this assignment pertains to the importance of communication and civic engagement on current policy and technological issues. To support students with this assignment, students will participate in a two-day mentoring workshop and receive individual editing/mentoring by members of The OpEd Project on October 27th and 28th, 2-5:30pm (note special days and times). Students will pitch their OpEds to different venues if they desire to, and unless another venue is secured they will have the opportunity to publish their pieces on the course’s blog. **Due: December 8, 2022.** 

### OpEd Project *Write to Change the World* Workshop
OpEd Project *Write to Change the World* workshops are designed to inspire and cultivate a greater sense of social responsibility by clarifying our potential impact on the world. We use op-eds as an action step, but the framework and curriculum can apply to any place where someone seeks to have an impact - at their university or institution, in business, in political office, and beyond. We work with individuals and communities and organizations across all fields, disciplines and issues. Our 'Write to Change the World' workshop is based on time-tested models of transformational learning, designed to unlock knowledge in powerful and unexpected ways. In this highly-interactive, energetic workshop, we explore the source of credibility and how to establish it; how to present ideas quickly and powerfully under pressure; the components of powerful, evidence-based argument; the difference between being “right” and being effective; and strategies for making a greater impact, including how to escape a pigeonhole, how to preach beyond the choir, and the value of seeing your argument as part of a bigger picture—and yourself as part of a larger public conversation. You’ll expand the way you think about your particular expertise, discover tools that help you “translate” niche ideas into large themes, and explore how to pitch your ideas. You will leave the workshop with concrete results, including a draft outline of an op-ed in hand, and will have ongoing access to OpEd Project resources, events and mentors.

**Participation Requirements:**
* All workshop participants must have access to a high-speed internet connection.
* Write to Change the World (WTCTW) is a dynamic workshop based on discovery through live group interaction. We ask that you participate continuously and in FULL (without skipping segments), because if you dip in and out of the workshop it will compromise your experience – and also the group experience.
* The workshop begins promptly at the start time. Please log in a few minutes early to address any technological concerns. Late participants may not be able to attend the workshop. 
* Write to Change the World (WTCTW) is based on human experience and interaction. To the greatest extent possible, we ask that you keep your CAMERA ON throughout the workshop, to maximize everyone's experience (and so we don’t pair anyone with an empty camera during breakouts).
* Write to Change the World is meant to be experienced live. In order to invite trust, vulnerability, and discovery, the group commits to privacy. Therefore we will not be sharing a recording. 
* To prepare, please brainstorm an idea that you'd like to turn into an opinion piece, and think about the question: What are you an expert in? Maybe it's something that is misunderstood or is missing altogether from the public conversation.
