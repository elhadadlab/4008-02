...
[**Course Syllabus**](https://github.com/elhadadlab/4008-02/raw/main/BINF%204008-02%20Course%20Syllabus.pdf){:target="_blank"}
...
**Op-Ed.** Students will write op-eds (800 words) that communicate the complexity of a chosen topic at the intersection of ethics, justice, and digital health to a general audience. The primary competency for this assignment pertains to communication. To support students with this assignment, students will participate in a one-day mentoring workshop and receive individual editing/mentoring by members of The OpEd Project. Students will pitch their OpEds to different venues if they desire to, and unless another venue is secured they will have the opportunity to publish their pieces on the course’s blog.
...
Failure to observe these rules of conduct will have serious academic consequences, up to and including dismissal from the university. If a faculty member suspects a breach of academic honesty, appropriate investigative and disciplinary action will be taken following Dean's Discipline procedures (https://gsas.columbia.edu/student-guide/policy-handbook/deans-discipline). Your grade should reflect your own work. If you believe you are going to have trouble completing an assignment, please talk to one of the instructors or TA in advance of the due date.
